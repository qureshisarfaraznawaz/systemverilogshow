...
unit xbus_bfm_u like uvm_bfm {
    ...
    -- This field is a pointer to the bus collector. Note that this field is set
    -- procedurally using connect_pointers().
    !bus_collector : xbus_bus_collector_u;
...
extend ARBITER xbus_bfm_u {
    ...
    -- This field is a pointer to the sequence driver in the arbiter agent.
    driver: xbus_arbiter_driver_u;
