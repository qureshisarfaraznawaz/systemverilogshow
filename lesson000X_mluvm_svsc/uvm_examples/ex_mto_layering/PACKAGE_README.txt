* Title: Sequences layering example, many-to-one layering
* Name: ex_mto_layering
* Version: 2.0.1
* Requires:
  specman {8.20..}
  uvm_e {2.0.1..}
...
* Description:
  ...
  Demonstrates implementation of Many-to-One layering - several upper layer
  datas are concatenated into one lower layer data item.
...
1. Install the ex_mto_layering package (see Installation)

2. In a suitable simulation directory, enter the following command:

   `sn_which.sh ex_mto_layering`/demo.sh
